...
export default function GlobalNotFound() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#000510] relative overflow-hidden">
      {/* Background Glow */}
      ...
      <div className="z-10 flex flex-col items-center text-center space-y-6 animate-fade-in-up">
        ...
        <Link 
          href="/dashboard"
          className="mt-8 px-8 py-3 bg-blue-600 hover:bg-blue-500 text-white font-medium rounded-xl transition-all shadow-lg shadow-blue-900/20 inline-flex items-center gap-2"
        >
          Return to Dashboard
        </Link>
      </div>
