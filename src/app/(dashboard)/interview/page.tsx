  ...
  if (sessions.length === 0 && recentAnalyses.length === 0) {
    return (
      <div className="max-w-4xl mx-auto space-y-8 animate-fade-in-up pb-12">
        ...
        <div className="bg-[#1a1916] border border-[#2d2a26] rounded-2xl p-8 sm:p-12 text-center space-y-6 relative overflow-hidden">
          ...
          <div className="pt-4 relative z-10">
            <Link
              href="/jobs"
              className="inline-flex items-center gap-2 px-6 py-3 bg-amber-500 hover:bg-amber-400 text-stone-900 font-medium rounded-lg transition-colors shadow-lg shadow-amber-900/20"
            >
      ...
      <div className="flex items-center justify-between gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <Link
            ...
            className="inline-flex items-center gap-2 px-4 py-2.5 bg-[#1a1916] border border-[#2d2a26] hover:border-amber-500/50 text-gray-300 hover:text-white font-medium rounded-lg transition-colors text-sm"
          >
          ...
          <Link
            href="/interview/new"
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#1a1916] border border-[#2d2a26] hover:border-amber-500/50 text-white font-medium rounded-lg transition-colors text-sm"
          >
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {recentAnalyses.map((analysis) => (
              <div 
                key={analysis.id}
                className="bg-[#0f0e0c] border border-amber-500/30 rounded-xl p-5 flex flex-col justify-between gap-4 relative overflow-hidden group"
              >
                <div className="absolute top-0 right-0 w-32 h-32 bg-amber-500/10 rounded-full blur-2xl pointer-events-none -translate-y-1/2 translate-x-1/2 group-hover:bg-amber-500/15 transition-colors" />
                ...
                <Link
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 px-4 py-2 bg-amber-500 hover:bg-amber-400 text-stone-900 text-sm font-bold rounded-lg transition-all shadow-lg shadow-amber-900/40 relative z-10"
                >
                  <Mic className="w-4 h-4" />
                  Begin Interview
                </Link>
        ...
        {sessions.map((session) => {
          ...
          return (
            <Link
              ...
              className="group bg-[#0f0e0c] border border-[#2d2a26] hover:border-amber-500/50 rounded-xl p-6 transition-all duration-300 relative overflow-hidden flex flex-col sm:flex-row sm:items-center justify-between gap-6"
            >
              ...
              <div className="relative z-10 space-y-3 flex-1">
                ...
                <div className="flex flex-wrap items-center gap-4 text-xs font-medium text-gray-400">
                  <span className="flex items-center gap-1.5 bg-[#1a1916] px-2.5 py-1 rounded-md border border-gray-800">
              ...
              <div className="relative z-10 shrink-0 flex items-center justify-between sm:justify-end gap-6 w-full sm:w-auto mt-2 sm:mt-0 border-t border-[#2d2a26] sm:border-t-0 pt-4 sm:pt-0">
                ...
                <div className="w-8 h-8 rounded-full bg-[#2d2a26]/40 flex items-center justify-center group-hover:bg-amber-500 transition-colors shrink-0">
